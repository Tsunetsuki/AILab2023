...
# Data Loading
# ====================================================
train = pd.read_csv('C:\HKA\AILab2023\Project\deberta/input/nbme-score-clinical-patient-notes/train.csv')
...
features = pd.read_csv('C:\HKA\AILab2023\Project\deberta/input/nbme-score-clinical-patient-notes/features.csv')
def preprocess_features(features):
    features.loc[27, 'feature_text'] = "Last-Pap-smear-1-year-ago"
    return features
features = preprocess_features(features)
patient_notes = pd.read_csv('C:\HKA\AILab2023\Project\deberta/input/nbme-score-clinical-patient-notes/patient_notes.csv')
